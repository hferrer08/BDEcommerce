...
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (1,'FIFA23 PS',70,1);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (2,'FIFA23 XBOX',85,3);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (3,'FIFA23 SWITCH',47,2);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (4,'Super Smash Bros',85,2);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (5,'Dragon Ball Xenoverse PS',52,1);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (6,'Dragon Ball Xenoverse XBOX',52,3);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (7,'Halo',70,3);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (8,'Bloodborne ',52,1);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (9,'Gears of War',85,3);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (10,'Killer Instinct',30,3);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (11,'Pokemon Espada y Escudo',70,2);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (12,'Dragon Ball Xenoverse Switch',47,2);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (13,'The Last Guardian ',47,1);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (14,'Sea of Thieves',70,3);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (15,'Detroit: Become Human ',30,1);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (16,'Titanfall',70,3);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (17,'Kirby',30,2);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (18,'God of war',20,1);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (19,'Forza Horizon 4',85,3);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (20,'Marvel\'s Spider-Man ',70,1);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (21,'The legend of zelda',20,2);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (22,'Animal Crossing',70,2);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (23,'Metroid Dread',70,2);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (24,'Super Mario Maker2',70,2);
INSERT INTO Producto (`idProducto`,`NombreProducto`,`Stock`,`idCategoria`) VALUES (25,'Bayonetta 2',85,2);
...
Tel VARCHAR (50), Ciud VARCHAR(30), Direc VARCHAR(100), CorreoE VARCHAR(50))
BEGIN 
INSERT INTO Cliente (`idCliente`,`Nombre`,`ApellidoPaterno`,`ApellidoMaterno`,`Telefono`,`Ciudad`,`Direccion`,`Email`)
VALUES (id, nombre, ApPaterno, ApMaterno, Tel, Ciud, Direc, CorreoE); 
END //
DELIMITER ;

call SPU_INS_CLIENTENUEVO (8542165, 'Hubert', 'Ferrer', 'Guerrero', '123456789', 'Barranquilla', 'Calle123#45-89', 'hubert.ferrerg8@gmail.com');
